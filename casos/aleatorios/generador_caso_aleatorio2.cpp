...
//  - Generador de casos aleatorios 2
//
...
const int MAX_SALTO = 1e2;

//Parecido al CasoAleatorio1, solo que en este hemos hecho que el rango de salto sea menor, porque habran menos nenufares conectados
//entre si. Aqui no se puede diferenciar tan facilmente el ufds con el bfs y dfs.
...
int main()
{
    ...
    ofstream output("CasoAleatorio2.txt");
