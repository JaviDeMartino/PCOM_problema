...
const int MAX_NUM_NENUFARES = 50;

const double MIN_COOR = 0.02;
const double MAX_COOR = 50;

const int MIN_MOSCAS = 0;
const int MAX_MOSCAS = 50;

const int MIN_SALTO = 0;
const int MAX_SALTO = 30;

//En este generador creamos los casos parecidos al aleatorio1, pero hemos disminuido el maximo de todas las variables para
//que salgan numeros mas pequeños
...
int main()
{
    ...
    ofstream output("CasoAleatorio5.txt");
