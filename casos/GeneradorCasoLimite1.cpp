...
// tienen que estar contados en la solucion final). El nenufar fragil lo colocamos en la esquina inferior derecha apartado porque no nos interesa
// en este caso.
...
// Lo que daria 2000 + 1000*3 = 5000.

int main() {

    ofstream output("CasoLimite1.txt");
    ...
    numNenufares = 4001;//2000 de la fila + 2000 de las de abajo correspondientes + 1 fragil apartado
    N = 100;
    M = 100;
    L = 0.01;
